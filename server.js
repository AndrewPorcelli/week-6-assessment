...
var rollbar = new Rollbar({
  accessToken: '8896273939b54104981fc958ffa39b4e',
...
rollbar.error('oh no, this is an error!');
rollbar.critical('this is an extreme error, lol!');
rollbar.warning('You are going to far');
